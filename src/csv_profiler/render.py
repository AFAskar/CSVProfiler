...
def md_table_header() -> list[str]:
    lines = []
    lines.append(
        "| Column Name | Type | Missing Values | Top Value | Non-empty Counts | Max | Min | Mean | Median | unique |"
    )
    lines.append(
        "|-------------|------|----------------|-----------|------------------|----|-----|------|--------|--------|"
    )
...
def createMD(data: dict):
    ...
    lines.extend(
        md_report_csv_summary(data["summary"]["Row Count"], data["summary"]["Columns"])
    )
